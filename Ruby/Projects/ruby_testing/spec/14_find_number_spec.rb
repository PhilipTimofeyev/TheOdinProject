...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 0 and max is 9' do
      it 'returns 4' do
        expect(game_guessing.make_guess).to be(4)
      end
    end
  ...
  describe '#game_over?' do
    ...
    subject(:end_game) { described_class.new(0, 9, random_number, 4) }
