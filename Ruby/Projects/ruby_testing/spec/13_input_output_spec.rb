...
describe NumberGame do
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid_two = '  '
        valid = '4'
        allow(game_loop).to receive(:player_input).and_return(invalid_one, invalid_two, valid)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      # remove the 'x' before running this test
      subject(:game_one) { described_class.new(3, '3', 3) }
      it 'outputs correct phrase' do
    ...
    context 'when count is 4 and over' do
      # remove the 'x' before running this test
      subject(:game_one) { described_class.new(3, '3', 100) }
      it 'outputs correct phrase' do
        not_good_phrase = "That was hard. It took you 100 guesses!\n"
        expect { game_one.final_message }.to output(not_good_phrase).to_stdout
      end
    end
  end
end
